...
class TongHop_benhTMH(scrapy.Spider):
    ...
    base_url = "https://vnexpress.net/suc-khoe/cac-benh/benh-tim-mach/benh-nguoi-lon"
    start_urls = crawler_utils.crawl_articles(base_url)
    ...
    def parse(self, response):
        ...
        file_exists = False
        try:
            with open('BenhNguoiLon.csv', 'r', encoding='utf-8'):
                file_exists = True
